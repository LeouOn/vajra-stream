...
| **Saka Dawa Calculations** | The system automatically calculates the 4th Tibetan month (from Losar) and broadcasts the 100,000× multiplier on Duchen, the full moon of that month. | `core/tibetan_calendar.py` anchors month 1 to published Phugpa/CTA Losar dates and counts 3.5 synodic months to Duchen. FPMT dates override when present (2024-05-23, 2025-06-11, 2026-05-31). Operator, LLM tools, WS, and the Command Center banner all call the same helper. Years outside 2022–2036 fall back to the Chinese month-4 proxy. Leap months between Losar and month 4 need a published Duchen or a `LEAP_MONTHS_BEFORE_SAKA` entry. | **Closed for 2022–2036.** Remaining: leap-month years without a published Duchen, and years before 2022. |
