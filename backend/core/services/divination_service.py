...
TAROT_MAJOR = {
    0: {"name": "The Fool", "element": "Air", "hebrew": "Aleph", "ruler": "Uranus", "meaning": "New beginnings, spontaneous adventure, faith"},
    1: {"name": "The Magician", "element": "Air", "hebrew": "Beth", "ruler": "Mercury", "meaning": "Willpower, manifestation, resourcefulness"},
    2: {"name": "The High Priestess", "element": "Water", "hebrew": "Gimel", "ruler": "Moon", "meaning": "Intuition, sacred secrets, subconscious"},
    3: {"name": "The Empress", "element": "Earth", "hebrew": "Daleth", "ruler": "Venus", "meaning": "Abundance, creativity, nature, mothering"},
    4: {"name": "The Emperor", "element": "Fire", "hebrew": "Heh", "ruler": "Aries", "meaning": "Structure, authority, fathering, discipline"},
    5: {"name": "The Hierophant", "element": "Earth", "hebrew": "Vav", "ruler": "Taurus", "meaning": "Tradition, spiritual guidance, conformity"},
    6: {"name": "The Lovers", "element": "Air", "hebrew": "Zayin", "ruler": "Gemini", "meaning": "Alignment of values, choices, harmony"},
    7: {"name": "The Chariot", "element": "Water", "hebrew": "Heth", "ruler": "Cancer", "meaning": "Determination, control, victory over obstacles"},
    8: {"name": "Strength", "element": "Fire", "hebrew": "Teth", "ruler": "Leo", "meaning": "Inner strength, patience, compassion"},
    9: {"name": "The Hermit", "element": "Earth", "hebrew": "Yod", "ruler": "Virgo", "meaning": "Inner guidance, solitude, introspection"},
    10: {"name": "Wheel of Fortune", "element": "Fire", "hebrew": "Kaph", "ruler": "Jupiter", "meaning": "Good luck, cycles of change, destiny"},
    11: {"name": "Justice", "element": "Air", "hebrew": "Lamed", "ruler": "Libra", "meaning": "Fairness, truth, law, cause and effect"},
    12: {"name": "The Hanged Man", "element": "Water", "hebrew": "Mem", "ruler": "Neptune", "meaning": "Surrender, release, new perspective"},
    13: {"name": "Death", "element": "Water", "hebrew": "Nun", "ruler": "Scorpio", "meaning": "Endings, transition, regeneration"},
    14: {"name": "Temperance", "element": "Fire", "hebrew": "Samekh", "ruler": "Sagittarius", "meaning": "Balance, alchemy, moderation"},
    15: {"name": "The Devil", "element": "Earth", "hebrew": "Ayin", "ruler": "Capricorn", "meaning": "Bondage, shadow self, materialism"},
    16: {"name": "The Tower", "element": "Fire", "hebrew": "Peh", "ruler": "Mars", "meaning": "Sudden upheaval, revelation, breakdown"},
    17: {"name": "The Star", "element": "Air", "hebrew": "Tzaddi", "ruler": "Aquarius", "meaning": "Hope, renewal, cosmic inspiration"},
    18: {"name": "The Moon", "element": "Water", "hebrew": "Qoph", "ruler": "Pisces", "meaning": "Illusion, fear, subconscious guidance"},
    19: {"name": "The Sun", "element": "Fire", "hebrew": "Resh", "ruler": "Sun", "meaning": "Vitality, warmth, success, truth"},
    20: {"name": "Judgement", "element": "Fire/Spirit", "hebrew": "Shin", "ruler": "Pluto", "meaning": "Awakening, rebirth, inner calling"},
    21: {"name": "The World", "element": "Earth", "hebrew": "Tav", "ruler": "Saturn", "meaning": "Completion, integration, travel"}
}
...
GEOMANTIC_FIGURES = {
    "Via": {"pattern": [1, 1, 1, 1], "translation": "The Way", "ruler": "Moon", "element": "Water", "meaning": "Movement, change, simplicity, flow"},
    "Populus": {"pattern": [2, 2, 2, 2], "translation": "The People", "ruler": "Moon", "element": "Water", "meaning": "Gathering, consensus, diffusion, passivity"},
    "Conjunctio": {"pattern": [2, 1, 1, 2], "translation": "The Conjunction", "ruler": "Mercury", "element": "Air", "meaning": "Union, meeting, agreement, logic"},
    "Albus": {"pattern": [2, 2, 1, 2], "translation": "The White", "ruler": "Mercury", "element": "Air", "meaning": "Wisdom, clarity, peace, purification"},
    "Amissio": {"pattern": [1, 2, 1, 2], "translation": "Loss", "ruler": "Venus", "element": "Earth", "meaning": "Letting go, financial loss, love gain, spiritual decay"},
    "Acquisitio": {"pattern": [2, 1, 2, 1], "translation": "Gain", "ruler": "Jupiter", "element": "Fire", "meaning": "Increase, wealth, expansion, success"},
    "Fortuna Major": {"pattern": [2, 2, 1, 1], "translation": "Greater Fortune", "ruler": "Sun", "element": "Fire", "meaning": "Inner victory, light, supreme success, protection"},
    "Fortuna Minor": {"pattern": [1, 1, 2, 2], "translation": "Lesser Fortune", "ruler": "Sun", "element": "Fire", "meaning": "External speed, quick success, unstable growth"},
    "Laetitia": {"pattern": [1, 2, 2, 2], "translation": "Joy", "ruler": "Jupiter", "element": "Air", "meaning": "Joy, laughter, expansion, good news, health"},
    "Tristitia": {"pattern": [2, 2, 2, 1], "translation": "Sorrow", "ruler": "Saturn", "element": "Earth", "meaning": "Sadness, structure, grounding, foundations, confinement"},
    "Puer": {"pattern": [1, 1, 2, 1], "translation": "The Boy", "ruler": "Mars", "element": "Fire", "meaning": "Impulsiveness, fight, vigor, initiative, anger"},
    "Puella": {"pattern": [1, 2, 1, 1], "translation": "The Girl", "ruler": "Venus", "element": "Water", "meaning": "Beauty, harmony, affection, superficial joy"},
    "Rubeus": {"pattern": [2, 1, 2, 2], "translation": "Red", "ruler": "Mars", "element": "Fire", "meaning": "Passion, blood, danger, warning, force"},
    "Carcer": {"pattern": [1, 2, 2, 1], "translation": "Prison", "ruler": "Saturn", "element": "Earth", "meaning": "Restriction, boundary, isolation, concentration, security"},
    "Caput Draconis": {"pattern": [2, 1, 1, 1], "translation": "Dragon's Head", "ruler": "North Node", "element": "Earth", "meaning": "Entry point, new beginnings, gain, spiritual growth"},
    "Cauda Draconis": {"pattern": [1, 1, 1, 2], "translation": "Dragon's Tail", "ruler": "South Node", "element": "Fire", "meaning": "Exit point, endings, purging, karma, decline"}
}
...
class DivinationService:
    ...
    def _render_tarot_card_svg(self, card: Dict[str, Any]) -> str:
        ...
        glow_color = "#00ffff" if element == "Water" else "#ff00ff" if element == "Fire" else "#00ff00" if element == "Earth" else "#ffea00"
  ...
  <text x="120" y="340" fill="{glow_color}" font-size="10" font-family="sans-serif" text-anchor="middle" letter-spacing="1.5">{orientation.upper()} ({element.upper()})</text>
    ...
    def _get_hexagram_details(self, pattern: List[int]) -> Tuple[str, str]:
        ...
        HEXAGRAM_MAP = {
            ...
            "100010": ("Chun / Difficulty at the Beginning", "Sprouting seed, dynamic growth against initial obstacles"),
            ...
            "011110": ("Ta Kuo / Preponderance of the Great", "Heavy beam bends, crisis requiring extraordinary action"),
            ...
            "111100": ("Ta Chuang / Power of the Great", "Steer holds horns, avoiding head-on clashes, inner discipline"),
            ...
            "100100": ("Chen / The Arousing (Thunder)", "Startling thunder, awakening, initial fear turning to laughter"),
            "001001": ("Kên / Keeping Still (Mountain)", "Meditation, stopping action at the right time, spine alignment"),
    ...
    def _render_hexagram_svg(self, primary: List[int], relating: List[int], raw_lines: List[int]) -> str:
        ...
        for i, val in enumerate(reversed(raw_lines)):
            ...
            if is_yang:
                ...
                svg_lines.append(f'<line x1="110" y1="{y}" x2="160" y2="{y}" stroke="{color}" stroke-width="7" {glow}/>')
  ...
  {lines_svg}
    ...
    def cast_geomancy(self) -> Dict[str, Any]:
        ...
        return {
            "figures": resolved,
            "houses": house_mapping,
            "svg": self._render_geomancy_shield_svg(resolved)
        }
    ...
    def _get_geomancy_figure_details(self, pattern: List[int]) -> Tuple[str, Dict[str, Any]]:
        for name, data in GEOMANTIC_FIGURES.items():
            if data["pattern"] == pattern:
                return name, data
        return "Unknown", {"translation": "Mystery", "ruler": "Cosmos", "element": "Spirit", "meaning": "Divine alignment"}
  ...
  {render_dots(pat, x, y, color)}
        ...
        for x1, y1, x2, y2, tx, ty in connectors:
            lines.append(f'<path d="M {x1} {y1+32} L {tx} {ty-32} M {x2} {y2+32} L {tx} {ty-32}" stroke="#334155" stroke-width="1.2" stroke-dasharray="2,2"/>')
