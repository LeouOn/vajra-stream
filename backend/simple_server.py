...
app = FastAPI(title="Vajra.Stream API", description="Sacred Technology Platform Backend", version="1.0.0")
...
active_sessions = {}
audio_status = {"is_playing": False, "active_frequencies": [], "spectrum": []}


@app.get("/")
async def root():
    """Root endpoint"""
    return {"message": "Vajra.Stream API", "version": "1.0.0", "status": "running"}
...
async def get_frequency_spectrum():
    ...
    return {"frequencies": audio_status["active_frequencies"], "amplitudes": audio_status["spectrum"]}
