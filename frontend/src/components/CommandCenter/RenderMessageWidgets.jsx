 ...
 * @component
 * @param {Object}   props
 * @param {Array}    props.toolCalls      - tool call results from the LLM chat response.
 * @param {Function} [props.onZoomItemClick] - callback invoked with a zoom-modal payload.
 */
import React from 'react';

export const RenderMessageWidgets = ({ toolCalls, onZoomItemClick }) => {
