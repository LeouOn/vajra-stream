...
const FOUR_IMMEASURABLES: FourImmeasurable[] = [
...
const BodhicittaBanner: React.FC<Props> = (_props: Props) => {
  ...
  const handleQuickBlessing = (practice: string) => {
...
export default BodhicittaBanner;
