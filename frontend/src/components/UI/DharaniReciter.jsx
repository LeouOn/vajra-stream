...
const CHAKRA_COLORS = { heart:'#22c55e', crown:'#a855f7', third_eye:'#6366f1', throat:'#06b6d4', solar_plexus:'#fbbf24', sacral:'#f97316', root:'#ef4444' };

// ─── Sacred Syllable Mandala ───
function MandalaVisual({ count, total, frequency, isReciting, chakra }) {
...
export default function DharaniReciter() {
  const [selected, setSelected] = useState(DHARANIS[0]);
