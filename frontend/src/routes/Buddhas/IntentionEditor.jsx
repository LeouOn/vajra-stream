 ...
 * @component
 * @param {Object}   props
 * @param {string}   props.value     Current intention text.
 * @param {function} props.onChange  Callback fired with the new string on change.
 */
...
export default function IntentionEditor({ value, onChange }) {
