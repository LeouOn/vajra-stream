 ...
 */
function CurrentBuddhaCard({ status }) {
  const cb = status?.current_buddha;
  const name = cb && typeof cb === 'object' && cb.name_chinese;
 ...
 * updates.
 */
function RecitationControls({ running, intention, loading, onToggle }) {
  return (
    <Button
