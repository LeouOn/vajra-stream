...
ROLES = [
    ...
    },
    {
        ...
        "virtue": "boundless compassion",
        "chinese": "菩萨",
        "chinese_pinyin": "Púsà",
        "chinese_description": "众生无边誓愿度，以大悲心代众生苦",
    },
    {
        "name": "Yogi",
        "icon": "🧘",
        ...
        "virtue": "self-mastery",
        "chinese": "行者",
        "chinese_pinyin": "Xíngzhě",
        "chinese_description": "以苦行炼心，于肉身中证得解脱",
    },
    {
        "name": "Dakini",
        "icon": "💃",
        "mantra": "vajrayogini",
        "virtue": "fierce wisdom",
        "chinese": "空行",
        "chinese_pinyin": "Kōngxíng",
        "chinese_description": "于虚空中舞蹈，以空行智慧斩断执着",
    },
    {
        "name": "Oracle",
        "icon": "👁",
        ...
        "chinese": "巫觋",
        "chinese_pinyin": "Wūxī",
        "chinese_description": "通天达地，以神谕之眼照见过去未来",
    },
    {
        "name": "Alchemist",
        "icon": "⚗️",
        ...
        "chinese": "丹士",
        "chinese_pinyin": "Dānshì",
        "chinese_description": "炼精化气，以转物之功化凡为圣",
    },
    {
        "name": "Trickster",
        "icon": "🦊",
        "mantra": "inari",
        "virtue": "sacred paradox",
        "chinese": "幻者",
        "chinese_pinyin": "Huànzhě",
        "chinese_description": "以戏谑破执，于荒谬中显真实相",
    },
    {
        "name": "Wanderer",
        "icon": "🚶",
        ...
        "virtue": "freedom",
        "chinese": "遊方",
        "chinese_pinyin": "Yóufāng",
        "chinese_description": "云游四方，无所在而无所不在",
    },
    {
        "name": "Guardian",
        "icon": "🛡️",
        "mantra": "archangel_michael",
        "virtue": "protection",
        "chinese": "护法",
        "chinese_pinyin": "Hùfǎ",
        "chinese_description": "守护正法，以金刚之力摧伏一切魔障",
    },
    {
        "name": "Bard",
        "icon": "🎵",
        ...
        "virtue": "inspiration",
        "chinese": "乐师",
        "chinese_pinyin": "Yuèshī",
        "chinese_description": "以音声弘法，以诗词唤醒沉睡的灵魂",
    },
    {
        "name": "Necromancer",
        "icon": "💀",
        "mantra": "hades",
        "virtue": "death and rebirth",
        "chinese": "渡亡",
        "chinese_pinyin": "Dùwáng",
        "chinese_description": "于生死之间摆渡，引导亡灵走向光明",
    },
    {
        "name": "Druid",
        "icon": "🌳",
        "mantra": "dagda",
        "virtue": "nature wisdom",
        "chinese": "木德",
        "chinese_pinyin": "Mùdé",
        "chinese_description": "与草木同呼吸，于自然循环中体悟天道",
    },
    {
        "name": "Paladin",
        "icon": "⚔️",
        "mantra": "michael",
        "virtue": "holy conviction",
        "chinese": "圣骑",
        "chinese_pinyin": "Shèngqí",
        "chinese_description": "以信仰为甲，以正义之剑守护善良",
    },
    {
        "name": "Shaman",
        "icon": "🪶",
        "mantra": "spirit_guide",
        "virtue": "spirit walking",
        "chinese": "萨满",
        "chinese_pinyin": "Sàmǎn",
        "chinese_description": "游走于三界之间，以灵魂之旅治愈众生",
    },
]
...
class CharacterGenerator:
    ...
    def _generate_name(self, element: dict, role: dict) -> str:
        ...
        role_suffixes = {
            ...
            "Bodhisattva": ["lotus", "heart", "vow", "mercy"],
            "Yogi": ["asana", "breath", "stillness", "peak"],
            "Dakini": ["sky", "flame", "dance", "void"],
            "Oracle": ["sight", "veil", "portent", "sigil"],
            "Alchemist": ["gold", "elixir", "vessel", "stone"],
            "Trickster": ["laugh", "guise", "riddle", "mask"],
            "Wanderer": ["path", "dust", "horizon", "wind"],
            "Guardian": ["ward", "aegis", "bulwark", "sanctuary"],
            "Bard": ["lyre", "verse", "chant", "echo"],
            "Necromancer": ["ash", "bone", "threshold", "veil"],
            "Druid": ["root", "grove", "stone", "moon"],
            "Paladin": ["oath", "light", "wrath", "crown"],
            "Shaman": ["spirit", "drum", "bone", "vision"],
        }
