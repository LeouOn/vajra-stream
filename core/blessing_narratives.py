...
class GeneratedStory:
    ...
    title: str
    story_text: str
    pure_land: PureLandTradition | None
...
class StoryGenerator:
    ...
    def generate_story(
        ...
        if self.use_llm and self.llm_client:
            return self._generate_with_llm(target_name, narrative_type, pure_land, custom_context)
        else:
            return self._generate_from_template(target_name, narrative_type, pure_land, custom_context)

    def _generate_from_template(
        self, target_name: str, narrative_type: NarrativeType, pure_land: PureLandTradition, custom_context: str
    ) -> GeneratedStory:
        ...
        return GeneratedStory(
            ...
            metadata={"template_tags": template.tags, "custom_context": custom_context},
        )
    ...
    def _generate_with_llm(
        ...
        if narrative_type == NarrativeType.PURE_LAND_ARRIVAL:
            ...
            prompt_parts.append(
                "This is a story of liberation from extreme suffering in hell realms.\n\n"
                "Create a narrative that:\n"
                "1. Honors the depth of the suffering without dwelling on graphic details\n"
                "2. Shows how compassion reaches even the darkest places\n"
                "3. Depicts the moment of liberation and transformation\n"
                "4. Emphasizes forgiveness, healing, and new beginning\n"
                "5. Ends with dedication for all beings in extreme suffering\n"
            )

        elif narrative_type == NarrativeType.EMPOWERMENT:
            prompt_parts.append(
                "This is a story of the powerless gaining power and agency.\n\n"
                "Create a narrative that:\n"
                "1. Acknowledges the reality of oppression and powerlessness\n"
                "2. Shows the awakening of inner strength and outer support\n"
                "3. Depicts empowerment as wise, compassionate use of power\n"
                "4. Shows the empowered helping others rise\n"
                "5. Ends with dedication for all oppressed beings\n"
            )

        elif narrative_type == NarrativeType.RECONCILIATION:
            prompt_parts.append(
                "This is a story of healing between one who harmed and one who was harmed.\n\n"
                "Create a narrative that:\n"
                "1. Honors the pain of both sides\n"
                "2. Shows genuine accountability without excusing harm\n"
                "3. Depicts forgiveness as empowerment, not weakness\n"
                "4. Shows transformation for both victim and perpetrator\n"
                "5. Ends with dedication for healing all cycles of violence\n"
            )
    ...
    def generate_batch_stories(
        ...
        for target in targets[:max_stories]:
            story = self.generate_story(target=target, narrative_type=narrative_type, pure_land=pure_land)
...
if __name__ == "__main__":
    ...
    story2 = generator.generate_story(
        target_name="Beings in Extreme Suffering", narrative_type=NarrativeType.HELL_LIBERATION
    )
