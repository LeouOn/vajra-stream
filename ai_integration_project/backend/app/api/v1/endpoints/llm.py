...
class ModelSwitchRequest(BaseModel):
    ...
    provider: str | None = Field(None, description="Provider preference")
...
# Import services
from backend.core.services.enhanced_llm_service import GenerationRequest, ModelProvider, enhanced_llm_service
...
async def get_available_models():
    ...
    try:
        ...
        return {"status": "success", "models": formatted_models, "count": len(formatted_models)}
...
async def clear_cache():
    ...
    try:
        ...
        return {"status": "success", "message": "LLM cache cleared successfully"}
