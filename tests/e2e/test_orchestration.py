...
from core.ritual_sequencer import RitualSequencer, RitualState, RitualPhase
...
async def test_ritual_sequencer_orchestration():
    ...
    # Setup the sequencer
    sequencer = RitualSequencer(
        outlook_generator=mock_generator,
        event_bus=event_bus
    )
    ...
    initial_context = RitualState(
        intention="Test Orchestration",
        genre="victory",
        tradition="universal"
    )
