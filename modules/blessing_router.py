...
class NaturalLanguageResolver:
    ...
    def resolve(self, target_spec: TargetSpecification) -> ResolvedTarget:
        ...
        if location_match:
            ...
            return ResolvedTarget(name=name, tradition=metadata.get("tradition", "universal"), attributes=metadata)
        ...
        return ResolvedTarget(name=text, tradition=metadata.get("tradition", "universal"), attributes=metadata)
...
class DefaultResolver:
    def resolve(self, target_spec: TargetSpecification) -> ResolvedTarget:
        ...
        return ResolvedTarget(
            name=target_spec.identifier, tradition=metadata.get("tradition", "universal"), attributes=metadata
        )
...
class BlessingRouter:
    ...
    def route_blessing(
        ...
        # Generate blessing
        self.blessing_service.generate_blessing(
            target_name=resolved_target.name, intention=intention, tradition=resolved_target.tradition
        )
