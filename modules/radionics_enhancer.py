...
class RadionicsEnhancer:
    ...
    def create_structural_link(self, link_type: str, target: str, metadata: dict | None = None) -> StructuralLink:
        """Creates and registers a new structural link."""
        link = StructuralLink(link_type=link_type, target=target, metadata=metadata or {})
