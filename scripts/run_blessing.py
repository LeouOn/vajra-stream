...
def main():
    ...
    parser.add_argument("--mode", choices=["blessing", "healing"], default="blessing", help="Mode: blessing or healing")
    ...
    parser.add_argument(
        "--level", type=int, choices=[2, 3], default=2, help="Hardware level: 2=passive crystals, 3=amplified"
    )

    parser.add_argument("--continuous", action="store_true", help="Run continuously until stopped (Ctrl+C)")
