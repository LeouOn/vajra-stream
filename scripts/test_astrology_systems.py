...
try:
    ...
    print(f"   Western: Ok. Dominant Element: {data['western']['dominant_element']}, Aspects: {len(data['western']['aspects'])}")
    ...
    print(f"   Indian (Vedic): Ok. Tithi: {panch['tithi']['name']}, Nakshatra: {panch['nakshatra']['name']}, Yoga: {panch['yoga']['name']}")
    ...
    print(f"   Chinese: Ok. Animal: {data['chinese']['zodiac_animal']}, Shichen: {data['chinese']['shichen']['name']}, Date: {data['chinese']['lunar_date']['formatted']}")
    ...
    print(f"   Planetary Hours: Ok. Ruler: {data['planetary_hours']['current_planetary_hour']}, Hour of Day: {data['planetary_hours']['hour_of_day']}")
...
async def test_service():
    try:
        ...
        print(f"   Legacy Moon Phase: {service_data['moon_phase']['phase_name']} ({service_data['moon_phase']['illumination']:.1f}% illumination)")
