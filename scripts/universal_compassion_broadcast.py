...
def main():
    ...
    targets_data = [
        ("all_suffering_living", "All Living Beings Suffering Now",
         ...
         "illness, or despair",
         "May all suffering cease. May all beings find healing, shelter, "
         "love, and liberation.", 10),
        ("all_recently_deceased", "All Beings Who Have Recently Passed",
         ...
         "May all who have passed find clear light, swift guidance, and "
         "liberation through the bardo.", 10),
        ("war_victims_global", "Victims of All Active Conflicts",
         ...
         "is danger. May reconciliation heal what violence has broken.", 9),
        ("disaster_victims_global", "Victims of Natural Disasters",
         ...
         "May the earth find stability. May shelter reach the displaced. "
         "May healing reach the injured.", 9),
        ("venezuela_earthquake", "Venezuela Earthquake Victims",
         ...
         "Liberation, healing, and peace for all beings affected by the "
         "Venezuela earthquake.", 10),
    ]
    ...
    print(f"  Mantras: 1080 (10 mala rounds x 108)")
    print()
    ...
    print(f"  Broadcast duration: 5 minutes")
    print(f"  Session: #{session_id}")
    print()
