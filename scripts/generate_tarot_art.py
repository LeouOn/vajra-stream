...
def _pips(suit: str, n: int) -> str:
    ...
    if suit == "Swords":
        if n == 2:
            return (f'{_sword(80, 130, 80)}'
                    f'{_sword(120, 130, 80)}')
        if n == 3:
            return (f'{_sword(60, 120, 70)}{_sword(100, 140, 70)}'
                    f'{_sword(140, 120, 70)}'
                    f'<path d="M70 200 Q100 220 130 200 Q100 240 70 200" '
                    f'fill="{RED}" stroke="{GOLD}" stroke-width="0.5"/>')
        if n == 4:
            return (f'{_sword(50, 100, 60)}{_sword(150, 100, 60)}'
        ...
        if n == 8:
            return (f'{_sword(40, 90, 40)}{_sword(160, 90, 40)}'
                    ...
                    f'stroke="{GOLD}" stroke-width="0.4"/>')
        if n == 9:
            return (f'{_sword(35, 90, 35)}{_sword(100, 90, 35)}{_sword(165, 90, 35)}'
                    ...
                    f'stroke="{GOLD}" stroke-width="0.4"/>')
        if n == 10:
            return (f'{_sword(35, 85, 28)}{_sword(100, 85, 28)}{_sword(165, 85, 28)}'
    ...
    if suit == "Cups":
        if n == 2:
            return (f'{_cup(75, 160)}{_cup(125, 160)}'
                    ...
                    f'fill="{GOLD}">♌</text>')
        if n == 3:
            return (f'{_cup(60, 130)}{_cup(100, 170)}{_cup(140, 130)}'
                    f'<path d="M30 240 Q100 260 170 240" stroke="{EARTH}" '
                    f'stroke-width="0.8" fill="none"/>')
        if n == 4:
            return (f'{_cup(50, 130)}{_cup(150, 130)}'
                    ...
                    f'stroke="{GOLD}" stroke-width="0.4"/>')
        if n == 5:
            return (f'{_cup(40, 200, 22)}{_cup(80, 200, 22)}{_cup(120, 200, 22)}'
        ...
        if n == 6:
            return (f'{_cup(40, 130)}{_cup(80, 130)}{_cup(120, 130)}{_cup(160, 130)}'
                    f'{_cup(60, 220)}{_cup(140, 220)}'
                    f'<g fill="{GOLD}">'
                    f'<circle cx="100" cy="180" r="6"/>'
                    f'</g>')
        if n == 7:
            return (f'{_cup(35, 110)}{_cup(80, 100)}{_cup(125, 110)}{_cup(170, 100)}'
        ...
        if n == 8:
            return (f'{_cup(50, 110)}{_cup(95, 110)}{_cup(140, 110)}{_cup(155, 145)}'
        ...
        if n == 9:
            return (f'{_cup(35, 100)}{_cup(70, 100)}{_cup(105, 100)}{_cup(135, 100)}'
        ...
        if n == 10:
            return (f'{_cup(40, 90)}{_cup(75, 90)}{_cup(110, 90)}{_cup(145, 90)}'
